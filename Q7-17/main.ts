...
var message:string=`My favourite number is ${favoriteNumber}`;
...
var Names:string[]=["Mubashir","Hanzala","Hammad","Zayan"];
console.log(Names[0]);
console.log(Names[1]);
console.log(Names[2]);
console.log(Names[3]);
...
var transportaion:string[]=["car","bike","bus","aeroplane"];
transportaion.map((curVal:string)=>console.log(`I would like to own a ${curVal}`));

//Q14: Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
var guest:string[]=["Rabia","Imran","Bushra",];
...
console.log(`${guest[0]} can not attend`);
...
guest.map((curVal:string)=>console.log(`Dear ${curVal}, I found a new table so I am inviting more people`));
...
guest.map((curVal:string)=>console.log(`Dear ${curVal}, I can invite only two people for dinner`));
// • Remove guests from your list one at a time until only two names remain in your list. Each time you pop a name from your list, print a message to that person letting them know you’re sorry you can’t invite them to dinner.
for(var i=guest.length-1;i>=2;i--){
    var removedGuest=guest.pop();
    console.log(`Sorry ${removedGuest} I am sorry I can’t invite you to dinner.`)
}
console.log(guest);
// • Print a message to each of the two people still on your list, letting them know they’re still invited.
guest.forEach((curVal:string)=>console.log(`Dear ${curVal} you are still invited`));
