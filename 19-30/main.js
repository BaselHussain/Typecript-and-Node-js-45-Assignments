...
var guest = ["Rameesha", "Basel"];
console.log("".concat(guest.length), "people will come to dinner");
...
var country = ["Pakistan", "America", "Switzerland", "India"];
console.log("List of Country:", country);
var car = { company: "Honda", isUsed: true, year: 2022 };
console.log(car);
...
var names = ["Basel", "Wajahat", "Alishba"];
// console.log(names{3});
console.log(names[0]);
...
var name_1 = "Basel";
var name_2 = "Basel Hussain";
var name_3 = "Mr.BaselHussain";
if (name_1 === name_2) {
...
var favoriteFruits = ["Mango", "apple", "kivi"];
